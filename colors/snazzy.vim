...
" Colors
let s:black            = { "gui": "#282a36", "cterm": "16"  }
let s:white            = { "gui": "#f1f1f0", "cterm": "16"  }
let s:red              = { "gui": "#ff5c57", "cterm": "16"  }
let s:green            = { "gui": "#5af78e", "cterm": "16"  }
let s:blue             = { "gui": "#57c7ff", "cterm": "16"  }
let s:pink             = { "gui": "#ff6ac1", "cterm": "16"  }
let s:cyan             = { "gui": "#9aedfe", "cterm": "16"  }
let s:yellow           = { "gui": "#f3f99d", "cterm": "16"  }
let s:brightBlack      = { "gui": "#686868", "cterm": "16"  }
let s:brightWhite      = { "gui": "#eff0eb", "cterm": "16"  }
" let s:brightRed        = { "gui": "#ff5c57", "cterm": "16"  }
" let s:brightGreen      = { "gui": "#5af78e", "cterm": "16"  }
...
call s:h("Comment", { "fg": s:yellow }) " any comment
...
call s:h("Repeat", { "fg": s:pink }) " for, do, while,ss etc.
...
call s:h("SpecialComment", { "fg": s:brightBlack }) " special things inside a comment
...
call s:h("ColorColumn", { "bg": s:brightBlack }) " used for the columns set with 'colorcolumn'
call s:h("Conceal", {}) " placeholder characters substituted for concealed text (see 'conceallevel')
call s:h("Cursor", { "fg": s:black, "bg": s:blue }) " the character under the cursor
call s:h("CursorIM", {}) " like Cursor, but used when in IME mode
call s:h("CursorColumn", { "bg": s:brightBlack }) " the screen column that the cursor is in when 'cursorcolumn' is set
if &diff
  " Don't change the background color in diff mode
  call s:h("CursorLine", { "gui": "underline" }) " the screen line that the cursor is in when 'cursorline' is set
else
  call s:h("CursorLine", { "bg": s:brightBlack }) " the screen line that the cursor is in when 'cursorline' is set
endif
...
call s:h("VertSplit", { "fg": s:brightBlack }) " the column separating vertically split windows
call s:h("Folded", { "fg": s:brightBlack }) " line used for closed folds
call s:h("FoldColumn", {}) " 'foldcolumn'
call s:h("SignColumn", {}) " column where signs are displayed
call s:h("IncSearch", { "fg": s:yellow, "bg": s:brightBlack }) " 'incsearch' highlighting; also used for the text replaced with ":s///c"
call s:h("LineNr", { "fg": s:brightBlack }) " Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
call s:h("CursorLineNr", {}) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
call s:h("MatchParen", { "fg": s:blue, "gui": "underline" }) " The character under the cursor or just before it, if it is a paired bracket, and its match.
call s:h("ModeMsg", {}) " 'showmode' message (e.g., "-- INSERT --")
call s:h("MoreMsg", {}) " more-prompt
call s:h("NonText", { "fg": s:brightBlack }) " '~' and '@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line).
call s:h("Normal", { "fg": s:white, "bg": s:black }) " normal text
call s:h("Pmenu", { "bg": s:black }) " Popup menu: normal item.
call s:h("PmenuSel", { "fg": s:black, "bg": s:blue }) " Popup menu: selected item.
call s:h("PmenuSbar", { "bg": s:brightBlack }) " Popup menu: scrollbar.
...
call s:h("SpecialKey", { "fg": s:brightBlack }) " Meta and special keys listed with ":map", also for text used to show unprintable characters in the text, 'listchars'. Generally: text that is displayed differently from what it really is.
...
call s:h("StatusLine", { "fg": s:white, "bg": s:brightBlack }) " status line of current window
call s:h("StatusLineNC", { "fg": s:brightBlack }) " status lines of not-current windows Note: if this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
call s:h("TabLine", { "fg": s:brightBlack }) " tab pages line, not active tab page label
call s:h("TabLineFill", {}) " tab pages line, where there are no labels
call s:h("TabLineSel", { "fg": s:white }) " tab pages line, active tab page label
call s:h("Title", { "fg": s:green }) " titles for output from ":set all", ":autocmd" etc.
call s:h("Visual", { "fg": s:black, "bg": s:brightBlack }) " Visual mode selection
call s:h("VisualNOS", { "bg": s:brightBlack }) " Visual mode selection when vim is "Not Owning the Selection". Only X11 Gui's gui-x11 and xterm-clipboard supports this.
...
call s:h("cssFontAttr", { "fg": s:yellow })
...
call s:h("cssMediaType", { "fg": s:yellow })
...
call s:h("jsonBoolean", { "fg": s:yellow })
...
call s:h("lessClass", { "fg": s:yellow })
...
call s:h("markdownRule", { "fg": s:brightBlack })
call s:h("markdownHeadingRule", { "fg": s:brightBlack })
...
call s:h("markdownBlockquote", { "fg": s:brightBlack })
...
call s:h("perlPOD", { "fg": s:brightBlack })
call s:h("perlSharpBang", { "fg": s:brightBlack })
...
call s:h("phpMethodsVar", { "fg": s:yellow })
call s:h("phpMagicConstants", { "fg": s:yellow })
call s:h("phpSuperglobals", { "fg": s:red })
call s:h("phpConstants", { "fg": s:yellow })
...
call s:h("gitcommitComment", { "fg": s:brightBlack })
